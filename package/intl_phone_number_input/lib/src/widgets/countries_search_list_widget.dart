            ...
            child: TextFormField(
              ...
              cursorColor: Colors.grey.withOpacity(0.4),
               decoration: InputDecoration(
                ...
                hintStyle: TextStyle(color: Colors.white, fontSize: 13,fontFamily: 'Gugi'),
              ...
              itemBuilder: (BuildContext context, int index) {
                ...
                return ListTile(
                  ...
                  title: Align(
                      ...
                      textAlign: TextAlign.start,style: TextStyle(color: Colors.white,fontSize: 16,fontFamily: 'Gugi',),)),
                  subtitle: Align(
                      alignment: AlignmentDirectional.centerStart,
                      child: Text('${country.dialCode ?? ''}',
                          textDirection: TextDirection.ltr,
                          textAlign: TextAlign.start,style: TextStyle(color: Colors.white,fontSize: 13,fontFamily: 'Gugi',))),
