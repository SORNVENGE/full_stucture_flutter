...
//  VykFootView
//
//  Created by Chris on 21/01/2021.
//
...
//! Project version number for VykFootView.
FOUNDATION_EXPORT double VykFootViewVersionNumber;

//! Project version string for VykFootView.
FOUNDATION_EXPORT const unsigned char VykFootViewVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <VykFootView/PublicHeader.h>
// FOUNDATION_EXPORT testFunction((int) bvalue ;
// FOUNDATION_EXPORT testFunction:(bool )value;
