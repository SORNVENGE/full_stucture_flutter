...
class _ProductDetailState extends State<ProductDetail> {
  ...
  Future<void> _launchPlatformTryOnShoes(String model) async {
    if(Platform.isAndroid){
      await _methodChannel.invokeMethod('switchView', model);
    }
  }
              ...
              children: [
                ShakeTransition(
                  ...
                  child: Padding(
                    ...
                    child: Text('Yeezy 350 V2'.toUpperCase(),
                      style: TextStyle(
                        fontSize: 24,
                        fontFamily: 'Gugi',
                        letterSpacing: 1,
                            ...
                            child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  GestureDetector(
                                    onTap: () {
                                      ...
                                      if(widget.product.model != ''){
                                        _launchPlatformTryOnShoes(widget.product.model);
                                      }
                                  ...
                                  GestureDetector(
                                      onTap: () {
                                        Navigator.push(context,
                                          MaterialPageRoute(builder: (context) => ProductPhotoView()));
                                      },
                                      child: ActionButton(
                                          child: Image.asset(
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      _launchPlatformTryOnShoes("https://vykingsneakerkitnative.s3.amazonaws.com/SneakerStudio/may_android_ios/air_jordan_1_turbo_green/offsets.json");
                                    },
                                    child: ActionButton(
                                        child: Container(
                                ...
                                child: Center(
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                        ...
                                        letterSpacing: 4,
                                        color:
                                            Color(0xFFf1f3f6).withOpacity(.7)),
                                  ),
                                ),
                              ),
                              Expanded(
